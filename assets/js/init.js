...
(function($) {
	...
	$(function() {
		...
		//load background
		var imgUrl = "/assets/images/iss043e184614.jpg", tmpImg = new Image();
		$(tmpImg).on("load", function () {
			...
			// $({xpos : 0, ypos : -500}).animate({ypos : 0 }, {
			// 	duration : 2000,
			// 	easing : "swing",
			// 	step: function () {
			// 		var p = this.xpos + "px " + this.ypos + "px";
			// 		$(".bgimg").css("background-position",  p);
			// 	}
			// });
